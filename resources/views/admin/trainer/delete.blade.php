                                        ...
                                        <div class="card-body" style="border: 1px solid rgba(181, 207, 207, 0.952)">
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="input-group mb-3">
                                                  <input type="email" name="email" value="{{$trainer_user->email}}" class="form-control" placeholder="Email" disabled>
                                                ...
                                                <div class="input-group mb-3">
                                                  <input type="number" name="phone" value="{{$trainer_user->phone}}" class="form-control" placeholder="Phone" disabled>
                                                  <div class="input-group-append">
                                                    <div class="input-group-text">
                                                      ...
                                                      <div class="modal-content bg-danger">
                                                        ...
                                                        <div class="modal-body">
                                                          <form method="post" enctype="multipart/form-data">
                                                            ...
                                                            @endif
                                                             <div class="input-group mb-3">
                                                              <input type="text" name="trainer_name" value="{{$trainer_user['trainer_name']}}" class="form-control" placeholder="Trainer Name" disabled>
                                                              <div class="input-group-append">
                                                                <div class="input-group-text">
