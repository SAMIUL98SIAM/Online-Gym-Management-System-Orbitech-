                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a href="/deletetrainer/{{$trainer_user['id']}}" type="button" data-toggle="modal" data-target="#modal-default"  style="color: #fff" class="btn btn-danger btn-app servideletebtn"> <i class="fas fa-trash"></i>Remove</a></td>
